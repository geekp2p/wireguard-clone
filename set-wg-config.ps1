...
try {
    ...
    $config = "set=1`nprivate_key=d096774f42849f3323689b4a8c2582cdb985c606777eff1963d843eee3a2e578`npublic_key=d9e642f06f468bba67e11ed4809bf50d7329b64f6403e5e2a290d3238e17a117`nendpoint=212.80.213.27:13233`npersistent_keepalive_interval=25`nallowed_ip=0.0.0.0/0`nallowed_ip=::/0`n`n"
